...
class AllocationSearch extends StatefulWidget {
  const AllocationSearch({super.key});

  @override
  State<AllocationSearch> createState() => _AllocationSearchState();
}

class _AllocationSearchState extends State<AllocationSearch> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        ...
        appBar: CustomAppBar("Add Points"),
        body: Column(
          children: [
            const SizedBox(height: 25.0),
            Text(
              "Contractor To Add Points",
                                      ...
                                      return Card(
                                        ...
                                        child: ListTile(
                                          onTap: () {
                                            Navigator.pushNamed(
                                              ...
                                              arguments: {
                                                ...
                                                "id": "${_users.id}",
                                                "pId":
                                                    "${productProvider!.getProduct!.data!.first.id}",
                                              },
                                            );
                                          },
                                          ...
                                          title: Column(
                                            ...
                                            children: [
                                              Text(
                                                  "${_users.cId == null ? "NA" : _users.cId}"),
                                              Text(
                                                  "${_users.name == null ? "NA" : _users.name}"),
                                            ],
                                          ),
                                          subtitle: Text(
                                              "${_users.number == null ? "NA" : _users.number}"),
                                          trailing: IconButton(
                                              onPressed: () {
                                                Navigator.pushNamed(
                                                  context,
